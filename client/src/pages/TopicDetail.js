                  ...
                  <motion.div 
                    ...
                    >
                      ...
                      <div style={{
                        ...
                        {quizResults.passed ? 'Conratulations!' : 'Not quite there LoL'}
                      </div>
                      <div style={{
                        fontSize: '48px',
                        color: 'var(--bright-blue)',
                        ...
                        >
                          ...
                          {quizResults.badgeImage && (
                            <img src = {quizResults.badgeImage.startsWith('/uploads')
                              ? `http://127.0.0.1:5000${quizResults.badgeImage}`
                              : quizResults.badgeImage }
                      ...
                      {!quizResults.passed && (
                        <div style={{
                          ...
                          You need {quizResults.requiredScore}% to pass. Review and Try again.
                        </div>
                      )}
