      ...
      {topic.isCompleted && !quizStarted && (
        ...
        >
          ...
          <div style={{ fontSize: '10px', color: 'var(--text-medium)' }}>
            You can review your answers and explanations below
          </div>
        </motion.div>
      )}
...
>
  ...
  {!quizStarted ? (
    ...
    // REVIEW MODE - Just show correct answers with explanations (no retaking)
    <div>
      <div style={{
        padding: '15px',
        background: 'rgba(16, 185, 129, 0.1)',
        ...
        ✅ REVIEW MODE - These are the correct answers with explanations
      </div>
      ...
      <div style={{ display: 'flex', gap: '10px', marginTop: '30px', justifyContent: 'center' }}>
        ...
        <button onClick={handleReturnHome} className="retro-btn">
          🏠 RETURN HOME
        </button>
      </div>
    </div>
  ) : quizResults ? (
    // Results Screen - Only shown after taking quiz for the first time
    <AnimatePresence>
      <motion.div
      ...
      >
        ...
        {/* Question Review with Explanations - ONLY IF PASSED */}
        {quizResults.passed && (
          <div style={{
            padding: '20px',
            background: 'rgba(59, 130, 246, 0.05)',
            ...
            <h4 style={{ fontSize: '14px', color: 'var(--primary-navy)', marginBottom: '20px', textAlign: 'center' }}>
                      ...
                      return (
                        <div
                          ...
                          style={{
                            ...
                            marginBottom: '8px',
                            border: `2px solid ${
                              isCorrectAnswer ? 'var(--success-green)' : 
                              isUserAnswer && !isCorrect ? 'var(--error-red)' : 
                              'var(--border-color)'
                            }`,
                        ...
                        >
                          ...
                          <span style={{ flex: 1 }}>{option}</span>
                          {isUserAnswer && (
                            <span style={{ fontSize: '8px', color: 'var(--text-medium)' }}>
                              YOUR ANSWER
                            </span>
                          )}
                          {isCorrectAnswer && (
        ...
        {!quizResults.passed && (
          <div style={{
            ...
            You need {quizResults.requiredScore}% to pass. Review the materials and try again!
          </div>
        )}
    ...
    // Quiz Questions - Only for users who haven't passed yet
    <div>
      <div style={{
        padding: '15px',
