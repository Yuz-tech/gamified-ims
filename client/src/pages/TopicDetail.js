            ...
            {!topic.mandatoryCompleted && (
              <div style = {{
                ...
                <label style = {{
                  ...
                  <input type = "checkbox"
                    checked={materialsConfirmed} onChange={(e) => setMaterialsConfirmed(e.target.checked)}
                    style={{ width: '20px', height: '20px', cursor: 'pointer' }} />
                    <span>
                      <strong>I confirm that I have reviewed the materials.</strong>
                      {window.alert('You reap what you sow')}
                    </span>
                </label>
              </div>
            )}
            ...
            {!topic.mandatoryCompleted ? (
              ...
              >
                ...
                <div style = {{ textAlign: 'center', padding: '20px' }}>
                  ...
                  <button onClick = {handleStartMandatory} className="retro-btn" style={{
                    width: '100%',
              ...
              {!topic.bonusCompleted && (
                <motion.div 
                  ...
                  animate={{ opacity: 1 }}
                  className="retro-card"
                  style={{ background: 'rgba(59, 130, 246, 0.05)', borderColor: 'var(--bright-blue)', marginBottom: '20px' }}>
                    ...
                    <div style = {{ textAlign: 'center', padding: '20px' }}>
                      <div style = {{ fontSize: '12px', marginBottom: '20px', lineHeight: '1.6' }}>
                        Answer 4 bonus questions. Each correct answer earns <strong>50 XP</strong>
                      </div>
        ...
        {currentStage === 'mandatory' && !mandatoryResult && (
          ...
          >
            ...
            <div style = {{ display: 'flex', gap: '10px' }}>
              <button onClick={handleSubmitMandatory} className="retro-btn" style={{ flex: 1 }}
              ...
              >
                ...
                <div style={{ display:'flex', flexDirection: 'column', gap: '10px' }}>
                  {question.options.map((option, oIndex) => (
                    <button key={oIndex} onClick={() => setBonusAnswers({
                      ...bonusAnswers, [qIndex + 1]: oIndex
                    })}
                    style={{
                      padding: '15px',
